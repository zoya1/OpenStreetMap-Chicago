...
def shape_element(element, node_attr_fields=NODE_FIELDS, way_attr_fields=WAY_FIELDS,
    ...
    way_nodes = []
    tags = []
    count = 0 # Handle secondary tags the same way for both node and way elements
